...
def create_model(pretrained_weights = None, input_size = (256,256,1), start_neurons=64):
    ...
    up6 = Conv2D(start_neurons * 8, 2, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(UpSampling2D(size = (2,2))(drop5))
    ...
    up7 = Conv2D(start_neurons * 4, 2, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(UpSampling2D(size = (2,2))(conv6))
    ...
    up8 = Conv2D(start_neurons * 2, 2, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(UpSampling2D(size = (2,2))(conv7))
    ...
    up9 = Conv2D(start_neurons * 1, 2, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(UpSampling2D(size = (2,2))(conv8))
