...
def create_model_U(pretrained_weights = None, input_size = (256,256,1), start_neurons=32):
    ...
    conv6 = Conv2D(start_neurons * 8, 3, activation = 'relu', padding = 'same')(conv6)                          #conv12     -> 32
    ...
    conv7 = Conv2D(start_neurons * 4, 3, activation = 'relu', padding = 'same')(conv7)                          #conv15     -> 64
    ...
    conv8 = Conv2D(start_neurons * 2, 3, activation = 'relu', padding = 'same')(conv8)                          #conv18     -> 128
    ...
    conv9 = Conv2D(start_neurons * 1, 3, activation = 'relu', padding = 'same')(conv9)                          #conv21     -> 256
